import { LayoutDashboard, Package, Users, ShoppingBag, Calendar, MapPin, FileText, Leaf, Megaphone, MessageCircle, Bookmark } from "lucide-react";
...
const allMenuItems = [
  ...
  { title: "Posts", url: "/posts", icon: MessageCircle, roles: ["Customer"] },
