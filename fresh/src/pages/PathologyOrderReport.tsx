...
type APIOrder = {
    ...
    payments: Payment[];
    files?: string[]; // ✅ Added for uploaded files
};
...
export default function PathologyOrderReport() {
    ...
    const fetchOrders = async () => {
        try {
            const response = await axios.get<APIOrder[]>(
                "http://localhost:3064/orders?vendorId=3"
            );
    ...
    const filteredOrders = useMemo(() => {
        return orders
            ...
            .filter((o) => (statusFilter && statusFilter !== "all" ? o.orderStatus === statusFilter : true))
            .filter((o) => (communityFilter && communityFilter !== "all" ? o.community.name === communityFilter : true))
            .filter((o) => {
    ...
    const handleFileUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        try {
            ...
            // Update selected order files locally
            setSelectedOrder({
                ...selectedOrder,
                files: selectedOrder.files ? [...selectedOrder.files, response.data.fileUrl] : [response.data.fileUrl],
            });
    ...
    return (
        <div className="flex flex-col min-h-screen">
                    ...
                    <Table>
                        <TableHeader>
                            <TableRow>
                                ...
                                {/* <TableHead className="text-center">Upload/View</TableHead> */}
                            </TableRow>
                        </TableHeader>
            ...
            {/* VIEW / UPLOAD ORDER MODAL */}
            {selectedOrder && (
                <Dialog open onOpenChange={() => setSelectedOrder(null)}>
                    <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
                        <DialogHeader>
                            <DialogTitle>Order #{selectedOrder.id}</DialogTitle>
                            <DialogDescription>Order items, payments, and files</DialogDescription>
                        </DialogHeader>
                        ...
                        {/* FILES UPLOAD */}
                        <div className="p-4 border rounded-lg mt-4">
                            <h3 className="font-semibold text-lg mb-2">Order Files</h3>
...
//                                 <TableHead>Created</TableHead>
//                                 <TableHead className="text-center">View</TableHead>
//                                 <TableHead className="text-center">Health Report</TableHead>
//                             </TableRow>
//                         </TableHeader>
