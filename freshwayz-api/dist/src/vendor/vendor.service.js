...
let VendorService = class VendorService {
    ...
    orderRepo;
    productRepo;
    marketingContentRepo;
    customerRepo;
    constructor(vendorRepo, categoriesRepo, userTypeRepo, orderRepo, productRepo, marketingContentRepo, customerRepo) {
        this.vendorRepo = vendorRepo;
        this.categoriesRepo = categoriesRepo;
        this.userTypeRepo = userTypeRepo;
        this.orderRepo = orderRepo;
        this.productRepo = productRepo;
        this.marketingContentRepo = marketingContentRepo;
...
exports.VendorService = VendorService = __decorate([
    ...
    __param(5, (0, typeorm_1.InjectRepository)(marketing_content_entity_1.MarketingContent)),
    __param(6, (0, typeorm_1.InjectRepository)(customer_entity_1.Customer)),
