...
let OrderService = class OrderService {
    ...
    productRepo;
    discountService;
    constructor(orderRepo, customerRepo, vendorRepo, communityRepo, listedOrderRepo, deliverySlotRepo, vendorSubscriptionPlanRepo, dailyPriceRepo, customerProductRepo, productRepo, discountService) {
    ...
    async placeOrderFromProductList(dto) {
        ...
        if (!productListItems || productListItems.length === 0) {
            throw new common_1.BadRequestException('No products in the list for this subscription plan');
        }
        const order = this.orderRepo.create({
            customer,
            vendor,
...
exports.OrderService = OrderService = __decorate([
    ...
    __param(8, (0, typeorm_1.InjectRepository)(customer_product_entity_1.CustomerProduct)),
    __param(9, (0, typeorm_1.InjectRepository)(product_entity_1.Product)),
