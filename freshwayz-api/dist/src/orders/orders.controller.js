...
__decorate([
    (0, common_1.Post)('place-from-product-list'),
    (0, swagger_1.ApiOperation)({ summary: 'Create order from customer product list' }),
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Order created from product list' }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], OrderController.prototype, "placeOrderFromProductList", null);
__decorate([
    (0, common_1.Post)(),
