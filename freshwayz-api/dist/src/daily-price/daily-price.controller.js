...
let DailyPriceController = class DailyPriceController {
    ...
    getPriceHistory(productId, vendorId) {
        return this.dailyPriceService.getPriceHistory(+productId, vendorId ? +vendorId : undefined);
    }
};
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get price history for a product' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Returns complete price change history' }),
    __param(0, (0, common_1.Param)('productId')),
    __param(1, (0, common_1.Query)('vendorId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String]),
    __metadata("design:returntype", void 0)
], DailyPriceController.prototype, "getPriceHistory", null);
