...
CREATE TABLE `customer` (
  ...
  `dietPreference` varchar(255) DEFAULT NULL,
  `createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
  `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6),
...
CREATE TABLE `health_profile` (
  ...
  `sleepHours` float DEFAULT NULL,
  `activityLevel` varchar(255) DEFAULT NULL,
  `dietPreference` varchar(255) DEFAULT NULL,
  `vitaminD` float DEFAULT NULL,
  `vitaminB12` float DEFAULT NULL,
  `cholesterol` float DEFAULT NULL,
  `fastingSugar` float DEFAULT NULL,
  `hba1c` float DEFAULT NULL,
  `reportFileCount` int DEFAULT '0',
  `reportFileNames` text,
  `analysisPrompt` text,
  `personalizedHealthReports` json DEFAULT NULL,
  `nutritionInsights` json DEFAULT NULL,
  `customDietGuidance` json DEFAULT NULL,
  `fitnessSuggestions` json DEFAULT NULL,
  `preventiveAlerts` json DEFAULT NULL,
  `nutritionAlerts` json DEFAULT NULL,
  `createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
  `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6),
  PRIMARY KEY (`id`),
...
CREATE TABLE `product` (
  ...
  `vendorSubscriptionPlanId` int DEFAULT NULL,
  `category` int DEFAULT NULL,
  `productType` varchar(255) NOT NULL DEFAULT 'VEG',
  PRIMARY KEY (`id`),
...
INSERT INTO `product` VALUES (1,'Nandini Curd','Nandini Curd, 500 g Pouch','https://freshwayz.dexpertsystems.com/uploads/1766133891075-995830909.webp','GM','500',NULL,1,1,4,'VEG'),(2,'Amul Milk','Amul Slim \'N\' Trim Double Toned Fresh Milk 500 ml','https://freshwayz.dexpertsystems.com/uploads/1766123455921-671983102.webp','ML','500',NULL,1,1,4,'VEG'),(3,'Aashirvaad Wheat Atta','Aashirvaad Wheat Atta, 1 KG','https://5.imimg.com/data5/ANDROID/Default/2022/4/KR/MI/RS/1600400/prod-20220428-1059022370213558067768775-jpg-1000x1000.jpg','KG','1',NULL,1,1,1,'VEG'),(4,'Daawat Traditional Basmati White Rice','Daawat Traditional Basmati White Rice - Authentic Extra Long Grain Basmati Rice - 5Kg Bag','https://m.media-amazon.com/images/I/41qb2ccHt6L._SY300_SX300_QL70_FMwebp_.jpg','KG','5',NULL,1,1,1,'VEG'),(5,'Oregano oil ','Oregano oil 10 ml Biomus','https://chemmarkt.de/cdn/shop/files/426b8a7a796b74632d15ff94841db9dc.jpg?v=1751373341','ML','10',NULL,1,1,3,'VEG'),(6,'Indus Valley','Indus Valley Bio Organic Cold Pressed Oil - Sweet Almond 100 ml','https://cdn.netmeds.tech/v2/plain-cake-860195/netmed/wrkr/products/pictures/item/free/resize-w:400/wczHgDH3sD-indus_valley_bio_organic_cold_pressed_oil_sweet_almond_100_ml_0_1.jpg','ML','100',NULL,1,1,3,'VEG'),(7,'Premium Jumbo Almond','Jumbo Almonds are rich in Qualities and benefits , Jumbo almonds help in reducing the Hunger and reduce the intake of calories .These Almonds can be used to Extract oil and Milk , Jumbo Almonds are long in nature and Extra bit in sweetness.','https://dryfruithouse.com/admin/uploadImages/DRYF103_0.jpg','KG','1',NULL,1,1,2,'VEG'),(8,'Cashew Nuts (kaju) Jumbo Sized','Indulge in the luxurious size and rich flavor of our jumbo cashew. Each bite delivers a delightful crunch and buttery texture, making it a premium choice for snacking.','https://dryfruithouse.com/admin/uploadImages/DRYF110_0.jpg','KG','1',NULL,1,1,2,'VEG'),(9,'Apple - Red Delicious, Premium','Known for its iconic deep red color and classic heart shape, the Red Delicious apple has a mildly sweet flavor and firm, crisp texture. It is best enjoyed fresh as a snack or added to salads for a burst of crunch.','https://www.bbassets.com/media/uploads/p/m/40033819_35-fresho-apple-shimla.jpg','KG','1',NULL,1,1,5,'VEG'),(10,'Banana - Robusta, Organically Grown','Robusta bananas are a popular and versatile everyday fruit. They have a creamy texture and sweet flavor, making them ideal for smoothies, baking, or enjoying on their own. This listing is for organically grown bananas.','https://www.bbassets.com/media/uploads/p/l/40023475_7-fresho-banana-robusta-organically-grown.jpg','KG','1',NULL,1,1,5,'VEG'),(11,' fresho! 10 mins fresho! Mushrooms','Fresho! mushrooms, especially Button and Oyster, are fresh, hand-picked varieties known for their mild flavor and versatility.','https://www.bbassets.com/media/uploads/p/l/10000273_18-fresho-mushrooms-button.jpg','GM','200',NULL,1,1,5,'VEG'),(12,' Broccoli','Nutrient-packed green broccoli with crisp, \"tree-like\" florets and a tender, edible stalk. A versatile and healthy addition to any meal, whether steamed, roasted, or raw','https://www.bbassets.com/media/uploads/p/l/10000062_25-fresho-broccoli.jpg','GM','200-300',NULL,1,1,6,'VEG'),(13,'Roasted Makhana','A light-as-air, crunchy snack packed with protein, fiber, and antioxidants. They support heart health and digestion, are low in calories, and come in flavors like classic Pink Salt, Peri Peri, or Cheese.','https://static.dilligrocery.com/90-large_default/fox-nuts-makhana.jpg','GM','100',NULL,1,1,9,'VEG'),(14,'https://static.dilligrocery.com/90-large_default/fox-nuts-makhana.jpg','Crunchy roasted chickpeas or chana (Indian black chickpea) laced with spicy masala or other seasonings. They offer a healthy balance of carbohydrates, protein, and fiber, making them an ideal, high-protein snack.','https://images.healthshots.com/healthshots/en/uploads/2022/09/19165004/roasted-chana-1600x900.jpg','GM','100',NULL,1,1,9,'VEG'),(15,'Personal Training','Personal Training','https://freshwayz.dexpertsystems.com/uploads/1768291236733-416530995.jpg','NUMBER','12',NULL,2,1,7,'VEG'),(16,'V.D.R.L. Rotator','A V.D.R.L. rotator is a laboratory instrument that provides a specific, uniform, orbital circular motion to mix samples for diagnostic tests, most commonly the Venereal Disease Research Laboratory (VDRL) test for syphilis.','https://5.imimg.com/data5/SELLER/Default/2023/8/335629324/SO/FH/ZR/1141243/v-d-r-l-rotator-1000x1000.jpg','NUMBER','1',NULL,4,1,10,'VEG'),(17,'ESAW 2500x Pathological Doctor Compound Student Binocular Microscope for Laboratory, Magnification 40x to 2500x (Field 18mm)','ESAW generally refers to Engineering Science Apparatus Workshop, a major Indian manufacturer and exporter of scientific instruments for education and research (like microscopes, meters, lab glassware, physics equipment).','https://m.media-amazon.com/images/I/61MstERkLZL._SY500_.jpg','NUMBER','1',NULL,4,1,10,'VEG'),(18,'Coconut Water','Coconut water is the clear, naturally sweet liquid from young green coconuts, valued as a hydrating, low-calorie drink rich in electrolytes (potassium, magnesium, sodium), vitamins, and amino acids.','https://distrapi.blob.core.windows.net/strapi-uploads/assets/Coconut_Water_Juice_bf6377e088.jpg','LITRE','1',NULL,1,1,12,'VEG'),(19,'Real Fruit Power Mixed Fruit Juice','A popular blended fruit juice drink, typically made from concentrate, often contains added sugar. Endorsed for its \"fruit power\" but not always 100% juice.','https://www.bbassets.com/media/uploads/p/l/40214941_6-real-activ-fruit-power-coconut-water.jpg','LITRE','1',NULL,1,1,12,'VEG'),(20,'Lettuce Salad Box','A basic mix of fresh, low-calorie greens, high in vitamins and fiber, for light meals.','https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTBCcvFlKuPVOatzSTCVdWbxOB-5Kdl2JvfPg&s','GM','100',NULL,1,1,13,'VEG'),(21,'Trikaya Salad','Trikaya salads ready-to-eat salad mixes featuring various fresh lettuces with added ingredients like cherry tomatoes, red cabbage, pomegranate, and raisins, often accompanied by a sesame-honey dressing for a sweet, crisp, and nutritious meal.','https://www.bbassets.com/media/uploads/p/l/40152795_1-trikaya-salad-mini-ready-to-eat.jpg','GM','50',NULL,1,1,13,'VEG'),(22,'Chana Masala with Roti/Brown Rice','Chickpeas cooked in a flavorful, protein-rich curry with vegetables, served with whole wheat rotis or brown rice','https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRTF3BoLl8HT35CEJG7dIb8iOmYV7i4V1-iTg&s','GM','300',NULL,1,1,14,'VEG'),(23,'Grilled Paneer & Veggies','Cottage cheese (paneer) grilled in herbs and lime, served with sautéed exotic vegetables or brown rice. High in protein and fiber.','https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQBhOgpINNJKSm3N3BZ9xvB2YerVbP8aOlG0Q&s','GM','200',NULL,1,1,14,'VEG'),(24,'Sugar Free Ice Cream-Vanilla','Sugar-free vanilla ice cream is a creamy, low-calorie frozen dessert that delivers classic vanilla flavor without the use of traditional sugar. ','https://www.bbassets.com/media/uploads/p/l/40013808_3-amul-sugar-free-ice-cream-vanilla-with-chocolate-sauce.jpg','ML','125',NULL,1,1,15,'VEG'),(25,' Sugar Free Ice Cream - Shahi Anjeer, With Chocolate Sauce',' Sugar Free Ice Cream - Shahi Anjeer, With Chocolate Sauce, 125 ml','https://www.bbassets.com/media/uploads/p/l/40091814_3-amul-sugar-free-ice-cream-anjeer-with-chocolate-sauce.jpg','ML','125',NULL,1,1,15,'VEG'),(26,'Millet Pizza Base Organic','Finally a guilt-free pizza. Introducing to you the only pizza base in India that is made from millets, introducing to you our delicious Organic Millet Pizza Base. Our pizza base is pre-baked, does not contain any yeast.','https://milletamma.com/cdn/shop/products/MilletPizzaBase.png?v=1738404242','GM','200',NULL,1,1,11,'VEG'),(27,'Little Millet Instant Noodles','Pasta and noodles are a fave. Comforting, easy-to-cook, and delicious. But if you are concerned about maida and other harmful content then MilletAmma got your back! MilletAmma has come up with Little Millet instant noodles. ','https://milletamma.com/cdn/shop/products/14a.jpg?v=1738411663','GM',' 175',NULL,1,1,11,'VEG'),(28,'Beginner Yoga Program','Ideal for newcomers, focusing on basic postures, breathing techniques, and flexibility to build a strong foundation.','https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR9UpCKutP2yCXEpd8nU4gOO7yHOUxCjUDhjw&s','MONTH','1',NULL,3,1,8,'VEG'),(29,'Meditation & Pranayama','Mind-focused practices to improve concentration, emotional balance, stress management, and inner peace.','https://www.rishikulyogshalarishikesh.com/blog/wp-content/uploads/2024/09/woman-practices-yoga-pranayama-breath-control-683x1024.jpg','MONTH','1',NULL,3,1,8,'VEG'),(30,'Muscle Building Plan','Muscle building, known scientifically as muscular hypertrophy, is the physiological process of increasing the size of skeletal muscles through the growth in size of their component cells.','https://freshwayz.dexpertsystems.com/uploads/1768298126161-654141385.jpeg','NUMBER','45',NULL,2,1,7,'VEG');
